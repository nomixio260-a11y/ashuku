...
7. **[P1] 合成フル統合(synthetic full consolidation)** — 世代スケーリング実測で
   判明した長期保持時の再アンカーコスト(§3.3)への根本対策。バックグラウンドで
   古いチェーンを「最新世代を新キーフレームとする逆向きデルタ」に再編成すれば、
   よく読む最新世代が最速・古い世代ほどチェーンが深い、という理想形になる
   (商用バックアップ製品の synthetic full と同じ発想)。
